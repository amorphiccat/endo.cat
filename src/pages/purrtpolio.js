    ...
    <Layout title={siteTitle}>
      ...
      <article className="post-content page-template no-image">
        <div className="post-content-body">
          <h2 id="heading-level-2">Purrtpolio</h2>
          <h3 id="heading-level-4">BatoFur</h3>
          <strong>
            <a href="../BatoFur">Event Page</a>
          </strong>
          <h3 id="heading-level-4">BluefoxFur</h3>
          <strong>
            <a href="../BluefoxFur">Event Page</a>
          </strong>
          <h3 id="heading-level-3">HwaseongFur</h3>
          <strong>
            <a href="../HwaseongFur">Event Page</a>
          </strong>
          <h3 id="heading-level-4">Nijimori</h3>
          <strong>
            <a href="../Nijimori">Event Page</a>
          </strong>
          <figure className="kg-card kg-image-card">
            <Img
              fluid={data.nijimori1.childImageSharp.fluid}
              className="kg-image"
            />
            <figcaption>fdsafdsafs</figcaption>
          </figure>
          <figure className="kg-card kg-image-card">
            <Img
              fluid={data.nijimori2.childImageSharp.fluid}
              className="kg-image"
            />
            <figcaption>fdsafdsafs</figcaption>
          </figure>
          <figure className="kg-card kg-image-card">
            <Img
              fluid={data.nijimori3.childImageSharp.fluid}
              className="kg-image"
            />
            <figcaption>fdsafdsafs</figcaption>
          </figure>
          <figure className="kg-card kg-image-card">
            <Img
              fluid={data.nijimori4.childImageSharp.fluid}
              className="kg-image"
            />
            <figcaption>fdsafdsafs</figcaption>
          </figure>

          <h4 id="heading-level-3">Equipments</h4>
          <dl>
            <dt>-2020 May</dt>
            <dd>
              <ul>
            ...
            <dd>
              <ul>
                <li>Canon M50</li>
                <li>Canon EF-M 22mm </li>
                <li>Canon EF-M 15-45mm</li>
                <li>Canon EF-M 55-200mm</li>
              </ul>
            </dd>
          </dl>
...
const indexQuery = graphql`
  query {
    ...
    nijimori1: file(relativePath: { eq: "IMG_6439.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 1360) {
          ...GatsbyImageSharpFluid
        }
    ...
    nijimori2: file(relativePath: { eq: "IMG_6446.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 1360) {
          ...GatsbyImageSharpFluid
        }
    ...
    nijimori3: file(relativePath: { eq: "IMG_6463.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 1360) {
          ...GatsbyImageSharpFluid
        }
    ...
    nijimori4: file(relativePath: { eq: "IMG_6437.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 1360) {
          ...GatsbyImageSharpFluid
        }
